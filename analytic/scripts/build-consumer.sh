...
# SMAP Analytics Consumer - Build and Push Script
...
PROJECT="smap"
SERVICE="smap-analytics-consumer"
DOCKERFILE="command/consumer/Dockerfile"
...
show_help() {
    cat << EOF
${GREEN}SMAP Analytics Consumer - Build and Push Script${NC}
...
Note:
    This builds the Analytics Consumer service.
    The consumer processes messages from RabbitMQ and performs analytics.
