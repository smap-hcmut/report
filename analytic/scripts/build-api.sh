...
# SMAP Analytics API - Build and Push Script
...
PROJECT="smap"
SERVICE="smap-analytics-api"
DOCKERFILE="command/api/Dockerfile"
...
show_help() {
    cat << EOF
${GREEN}SMAP Analytics API - Build and Push Script${NC}
...
Note:
    This builds the Analytics API service.
    The API provides REST endpoints for querying analytics data.
