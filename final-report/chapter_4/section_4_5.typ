...
#pad(left: 40pt)[#image("../images/chapter_3/overall-use-case-diagram.svg", width: 85%)]
...
#pad(left: 40pt)[#image("../images/chapter_3/business-process-main-flow.svg", width: 85%)]
...
#pad(left: 20pt)[#image("../images/chapter_4/seq-authentication-flow.svg", width: 95%)]
...
#pad(left: 20pt)[#image("../images/chapter_4/seq-project-lifecycle-flow.svg", width: 95%)]
...
#pad(left: 20pt)[#image("../images/chapter_4/seq-dryrun-flow.svg", width: 95%)]
...
#pad(left: 20pt)[#image("../images/chapter_4/seq-analytics-pipeline-flow.svg", width: 95%)]
...
#pad(left: 20pt)[#image("../images/chapter_4/seq-knowledge-chat-flow.svg", width: 95%)]
#context (align(center)[_Hình #image_counter.display(): Quy trình tìm kiếm và hỏi đáp theo ngữ cảnh_])
#image_counter.step()

#pad(left: 20pt)[#image("../images/chapter_4/seq-notification-alert-flow.svg", width: 95%)]
