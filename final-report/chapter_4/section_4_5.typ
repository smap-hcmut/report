...
Sơ đồ dưới đây mô tả dòng nghiệp vụ tổng quát của SMAP từ thiết lập chiến dịch, cấu hình cảnh báo bổ sung khi cần, vận hành theo dõi, cho đến khai thác kết quả hoặc nhận cảnh báo.
...
#context (
  align(
    center,
  )[_Hình #image_counter.display(): Sơ đồ hoạt động UC-05B - Lưu hoặc cập nhật cấu hình cảnh báo khủng hoảng_]
)
#image_counter.step()
