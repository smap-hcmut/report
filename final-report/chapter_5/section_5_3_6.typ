...
=== 5.3.6 Knowledge Service

Knowledge Service là dịch vụ chịu trách nhiệm cho knowledge retrieval và knowledge materialization layer của hệ thống SMAP. Khác với các service chỉ thuần HTTP hoặc chỉ thuần consumer runtime, service này kết hợp cả lane indexing downstream lẫn lane consumption đồng bộ để biến analytics outputs thành tri thức có thể tìm kiếm, hỏi đáp và tái sử dụng. Ngoài bộ capability cốt lõi gắn với Chương 4, service còn có một nhánh report generation mở rộng ở phía knowledge layer.
