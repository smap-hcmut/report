...
Service này đáp ứng trực tiếp FR-10 về Knowledge Search and Chat, đồng thời tham gia trực tiếp vào UC-05 về Execute Analytics and Build Knowledge và UC-06 về Search and Chat Over Knowledge. Ngoài các capability đã traceable rõ ở Chương 4, service còn có report generation như một capability mở rộng của knowledge layer.
