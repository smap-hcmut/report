...
- Cách chia theo `Collector`, `Speech2Text`, `WebSocket` cũng làm lệch khỏi cách hệ thống hiện tại đang được tổ chức thành `identity-srv`, `project-srv`, `ingest-srv`, `analysis-srv`, `knowledge-srv`, `notification-srv` và `scrapper-srv`.
...
- Tách rõ `identity-srv`, `project-srv`, `ingest-srv`, `analysis-srv`, `knowledge-srv`, `notification-srv` và `scrapper-srv` để khớp với Chương 3 và 5.2.
...
- `5.3.8 Scrapper Worker Service`
  - Đã được bổ sung theo current implementation của `scrapper-srv`.
