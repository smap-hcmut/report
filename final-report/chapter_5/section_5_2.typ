...
#text()[
  ...
  #table(
    ...
    [Phù hợp cho giao diện người dùng hiện đại, hỗ trợ i18n, analytics API integration và mở rộng đa hình thức triển khai.],
