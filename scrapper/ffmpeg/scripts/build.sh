...
# SMAP FFmpeg Service - Build and Push Script
...
show_help() {
    cat << EOF
${GREEN}SMAP FFmpeg Service - Build and Push Script${NC}
...
Note:
    This builds the FFmpeg API service for audio/video processing.
    The service provides HTTP endpoints for media conversion.
