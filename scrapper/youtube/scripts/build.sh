...
# SMAP YouTube Scraper - Build and Push Script
...
show_help() {
    cat << EOF
${GREEN}SMAP YouTube Scraper - Build and Push Script${NC}
...
Note:
    This builds the YouTube scraper worker service.
    The service processes YouTube crawling tasks from RabbitMQ.
