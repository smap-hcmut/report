...
# SMAP tiktok Scraper - Build and Push Script
...
show_help() {
    cat << EOF
${GREEN}SMAP tiktok Scraper - Build and Push Script${NC}
...
Note:
    This builds the tiktok scraper worker service.
    The service processes tiktok crawling tasks from RabbitMQ.
