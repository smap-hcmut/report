...
type Subscription struct {
	...
	Status      SubscriptionStatus `boil:"status" json:"status" toml:"status" yaml:"status"`
	TrialEndsAt null.Time          `boil:"trial_ends_at" json:"trial_ends_at,omitempty" toml:"trial_ends_at" yaml:"trial_ends_at,omitempty"`
...
type whereHelperSubscriptionStatus struct{ field string }

func (w whereHelperSubscriptionStatus) EQ(x SubscriptionStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperSubscriptionStatus) NEQ(x SubscriptionStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperSubscriptionStatus) LT(x SubscriptionStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperSubscriptionStatus) LTE(x SubscriptionStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperSubscriptionStatus) GT(x SubscriptionStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperSubscriptionStatus) GTE(x SubscriptionStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GTE, x)
}
func (w whereHelperSubscriptionStatus) IN(slice []SubscriptionStatus) qm.QueryMod {
...
func (w whereHelperSubscriptionStatus) NIN(slice []SubscriptionStatus) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
var SubscriptionWhere = struct {
	...
	Status      whereHelperSubscriptionStatus
	TrialEndsAt whereHelpernull_Time
	...
	PlanID:      whereHelperstring{field: "\"subscriptions\".\"plan_id\""},
	Status:      whereHelperSubscriptionStatus{field: "\"subscriptions\".\"status\""},
	TrialEndsAt: whereHelpernull_Time{field: "\"subscriptions\".\"trial_ends_at\""},
	StartsAt:    whereHelpertime_Time{field: "\"subscriptions\".\"starts_at\""},
	EndsAt:      whereHelpernull_Time{field: "\"subscriptions\".\"ends_at\""},
	CancelledAt: whereHelpernull_Time{field: "\"subscriptions\".\"cancelled_at\""},
	...
	DeletedAt:   whereHelpernull_Time{field: "\"subscriptions\".\"deleted_at\""},
}
...
func (r *subscriptionR) GetPlan() *Plan {
	if r == nil {
		return nil
	}
...
var (
	subscriptionAllColumns            = []string{"id", "user_id", "plan_id", "status", "trial_ends_at", "starts_at", "ends_at", "cancelled_at", "created_at", "updated_at", "deleted_at"}
	subscriptionColumnsWithoutDefault = []string{"user_id", "plan_id"}
	subscriptionColumnsWithDefault    = []string{"id", "status", "trial_ends_at", "starts_at", "ends_at", "cancelled_at", "created_at", "updated_at", "deleted_at"}
...
func (q subscriptionQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Subscription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboiler: failed to execute a one query for subscriptions")
	}
...
func (q subscriptionQuery) All(ctx context.Context, exec boil.ContextExecutor) (SubscriptionSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "sqlboiler: failed to assign all query results to Subscription slice")
	}
...
func (q subscriptionQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to count subscriptions rows")
	}
...
func (q subscriptionQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "sqlboiler: failed to check if subscriptions exists")
	}
...
func (o *Subscription) Plan(mods ...qm.QueryMod) planQuery {
...
func (subscriptionL) LoadPlan(ctx context.Context, e boil.ContextExecutor, singular bool, maybeSubscription interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qmhelper.WhereIsNull(`plans.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetPlan of the subscription to the related item.
// Sets o.R.Plan to related.
// Adds o to related.R.Subscriptions.
func (o *Subscription) SetPlan(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Plan) error {
	var err error
	if insert {
...
func Subscriptions(mods ...qm.QueryMod) subscriptionQuery {
	mods = append(mods, qm.From("\"subscriptions\""), qmhelper.WhereIsNull("\"subscriptions\".\"deleted_at\""))
	q := NewQuery(mods...)
...
func FindSubscription(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Subscription, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"subscriptions\" where \"id\"=$1 and \"deleted_at\" is null", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboiler: unable to select from subscriptions")
	}
...
func (o *Subscription) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("sqlboiler: no subscriptions provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to insert into subscriptions")
	}
...
func (o *Subscription) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("sqlboiler: unable to update subscriptions, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to update subscriptions row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by update for subscriptions")
	}
...
func (q subscriptionQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to update all for subscriptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to retrieve rows affected for subscriptions")
	}
...
func (o SubscriptionSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to update all in subscription slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to retrieve rows affected all in update all subscription")
	}
	return rowsAff, nil
}
...
func (o *Subscription) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("sqlboiler: no subscriptions provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("sqlboiler: unable to upsert subscriptions, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(subscriptionPrimaryKeyColumns) == 0 {
				return errors.New("sqlboiler: unable to upsert subscriptions, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to upsert subscriptions")
	}
...
func (o *Subscription) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if o == nil {
		return 0, errors.New("sqlboiler: no Subscription provided for delete")
	}
	...
	if hardDelete {
		...
		sql = fmt.Sprintf("UPDATE \"subscriptions\" SET %s WHERE \"id\"=$2",
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
		valueMapping, err := queries.BindMapping(subscriptionType, subscriptionMapping, append(wl, subscriptionPrimaryKeyColumns...))
		if err != nil {
			return 0, err
		}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to delete from subscriptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by delete for subscriptions")
	}
...
func (q subscriptionQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("sqlboiler: no subscriptionQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to delete all from subscriptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by deleteall for subscriptions")
	}
...
func (o SubscriptionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
	...
	if hardDelete {
		...
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"subscriptions\" SET %s WHERE "+
			strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 2, subscriptionPrimaryKeyColumns, len(o)),
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to delete all from subscription slice")
	}
...
func (o *SubscriptionSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to reload all in SubscriptionSlice")
	}
...
func SubscriptionExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"subscriptions\" where \"id\"=$1 and \"deleted_at\" is null limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "sqlboiler: unable to check if subscriptions exists")
	}
