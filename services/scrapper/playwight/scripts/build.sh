...
# SMAP Playwright Service - Build and Push Script
...
show_help() {
    cat << EOF
${GREEN}SMAP Playwright Service - Build and Push Script${NC}
...
Note:
    This builds the Playwright service for browser automation.
    The service provides WebSocket and HTTP endpoints for crawling.
