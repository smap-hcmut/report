"""
Property-based tests for YouTube batch upload functionality.
...
def crawl_result_strategy(draw):
    ...
    if success:
        ...
        content.url = f"https://youtube.com/watch?v={content.external_id}"
        ...
        content.duration_seconds = draw(st.integers(min_value=1, max_value=3600))
        content.tags = []
        ...
        content.channel_id = "testchannel"
