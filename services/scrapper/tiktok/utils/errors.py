"""
Structured Error Response Builder for TikTok Crawler
...
class RateLimitError(CrawlerError):
    ...
    def __init__(self, message: str = "Rate limited by platform", details: Optional[Dict[str, Any]] = None):
...
class ContentNotFoundError(CrawlerError):
    ...
    def __init__(self, message: str = "Content not found", details: Optional[Dict[str, Any]] = None):
...
class ContentRemovedError(CrawlerError):
    ...
    def __init__(self, message: str = "Content has been removed", details: Optional[Dict[str, Any]] = None):
...
class ParseError(CrawlerError):
    ...
    def __init__(self, message: str = "Failed to parse response", details: Optional[Dict[str, Any]] = None):
...
class MediaDownloadError(CrawlerError):
    ...
    def __init__(self, message: str = "Media download failed", details: Optional[Dict[str, Any]] = None):
