...
#pad(left: 100pt)[#image("../images/activity/1.png", width: 80%)]
...
#pad(left: 50pt)[#image("../images/activity/2.png", height: 85%)]
...
#image("../images/activity/dry.png", height: 86%)
...
#pad(left: 20pt)[#image("../images/activity/4.png", height: 88%)]
...
#pad(left: 50pt)[#image("../images/activity/5.png", width: 93%)]
...
#pad(left: 60pt)[#image("../images/activity/6.png", width: 82%)]
