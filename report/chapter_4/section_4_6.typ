=== 4.6.1 Giới thiệu và phương pháp tiếp cận
...
==== 4.6.1.2 Phương pháp mô hình hóa kiến trúc
...
=== 4.6.2 Lựa chọn Architecture Style

==== 4.6.2.1 Bối cảnh quyết định
...
==== 4.6.2.2 Phân tích các lựa chọn
