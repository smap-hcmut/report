...
#text(size: 10pt)[
  ...
  #table(
    ...
    table.cell(align: center + horizon)[*Notes*],

    table.cell(align: center + horizon, inset: (y: 0.6em))[bcrypt],
    table.cell(align: center + horizon)[Rất cao],
    table.cell(align: center + horizon)[Chậm, by design],
    table.cell(align: center + horizon)[Thấp],
    table.cell(align: center + horizon)[Industry standard, adaptive cost],
    ...
    table.cell(align: center + horizon)[Winner of Password Hashing Competition 2015],

    table.cell(align: center + horizon, inset: (y: 0.6em))[PBKDF2],
    table.cell(align: center + horizon)[Cao],
    table.cell(align: center + horizon)[Trung bình],
    table.cell(align: center + horizon)[Thấp],
    table.cell(align: center + horizon)[NIST approved, widely supported],

    table.cell(align: center + horizon, inset: (y: 0.6em))[SHA256],
    table.cell(align: center + horizon)[Thấp],
    table.cell(align: center + horizon)[Rất nhanh],
    table.cell(align: center + horizon)[Thấp],
    table.cell(align: center + horizon)[Không khuyến nghị cho passwords, quá nhanh],
  )
]
