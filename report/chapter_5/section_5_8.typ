...
Mục 5.8 đã chứng minh thiết kế hệ thống SMAP đáp ứng đầy đủ các yêu cầu từ Chương 4. Ma trận truy xuất nguồn gốc cho thấy 7 yêu cầu chức năng, 7 đặc tính kiến trúc và các yêu cầu phi chức năng về hiệu năng, an toàn, trải nghiệm đều được hiện thực với evidence cụ thể trong các mục 5.1 đến 5.6.
