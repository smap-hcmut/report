...
| Crawl task publish | RabbitMQ publisher | `../scrapper-srv/app/publisher.py` | `publish_task`, `publish_completion` |
| Worker bootstrap | FastAPI lifespan + worker startup | `../scrapper-srv/app/main.py`, `../scrapper-srv/app/worker.py` | `lifespan`, `Worker.start` |
